...
import { Home, Calendar, LogOut, Bell, Search, User } from 'lucide-react';
...
const BoardingLayout = () => {
  ...
  const navItems = [
    { name: 'Dashboard', path: '/boarding/dashboard', icon: Home },
    { name: 'Bookings', path: '/boarding/appointments', icon: Calendar },
    { name: 'Profile', path: '/boarding/profile', icon: User },
  ];
    ...
    <div className="flex h-screen bg-gray-50 font-poppins overflow-hidden">
      ...
      <aside className="w-72 bg-white border-r border-gray-100 hidden md:flex flex-col shadow-sm">
        <div className="p-6 border-b border-gray-100">
          ...
          <div className="mt-2 text-xs font-semibold text-gray-400 uppercase tracking-wider">Boarding Portal</div>
        </div>
